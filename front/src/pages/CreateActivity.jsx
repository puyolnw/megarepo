  ...
  useEffect(() => {
    const fetchAcademicYears = async () => {
      try {
        ...
        // Set default to current year if API fails
                      ...
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label htmlFor="academic_year" className="form-label">
                            <i className="fas fa-calendar-alt me-2"></i>ปีการศึกษา *
                          </label>
                          <select
                          ...
                          <div className="form-text">
                            เลือกปีการศึกษาที่จัดกิจกรรมนี้
                          </div>
                        </div>
                      </div>
                      <div className="col-md-4">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setFormData({
                        ...
                        location: '',
                        max_participants: '',
                        academic_year: academicYears.find(year => year.is_active)?.year || '',
                        status: 'OPEN'
                      });
                    }}
                  >
