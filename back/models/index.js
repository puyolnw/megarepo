...
User.hasMany(AcademicYear, { foreignKey: 'created_by', as: 'createdAcademicYears' });
AcademicYear.belongsTo(User, { foreignKey: 'created_by', as: 'creator' });

// Activity-AcademicYear associations
